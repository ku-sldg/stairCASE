...
Definition f_fac := {|
  ...
  fn_body :=
(Sifthenelse (Ebinop Oeq (Etempvar _x tint) (Econst_int (Int.repr 1) tint)
               tint)
  ...
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Ebinop Osub (Etempvar _x tint) (Econst_int (Int.repr 1) tint) tint) ::
       nil))
    (Sreturn (Some (Ebinop Omul (Etempvar _x tint) (Etempvar _t'1 tint) tint)))))
|}.
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_result, tint) :: (_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _result (Econst_int (Int.repr 3) tint))
    (Ssequence
      (Scall (Some _t'1)
        (Evar _fac (Tfunction (Tcons tint Tnil) tint cc_default))
